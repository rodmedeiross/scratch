...
type DeleteFeedFollowsByUserIdParams struct {
	ID     uuid.UUID
	UserID uuid.UUID
}

func (q *Queries) DeleteFeedFollowsByUserId(ctx context.Context, arg DeleteFeedFollowsByUserIdParams) error {
	_, err := q.db.ExecContext(ctx, deleteFeedFollowsByUserId, arg.ID, arg.UserID)
	return err
}
